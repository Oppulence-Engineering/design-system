...
import { EventFilterSchema } from "./eventFilter.ts";
import { RetryOptions } from "./schemas.ts";
...
export type FetchRetryHeadersStrategy = z.infer<
  typeof FetchRetryHeadersStrategy
>;
...
export type FetchRetryBackoffStrategy = z.infer<
  typeof FetchRetryBackoffStrategy
>;
...
export const FetchRetryByStatusOptions = z.record(
  z.string(),
  FetchRetryStrategy,
);
...
/** An object where the key is a status code pattern and the value is a retrying strategy. Supported patterns are:
  ...
  */
export type FetchRetryByStatusOptions = Prettify<
  z.infer<typeof FetchRetryByStatusOptions>
>;
