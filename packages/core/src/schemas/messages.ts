...
export type BackgroundWorkerServerMessages = z.infer<
  typeof BackgroundWorkerServerMessages
>;
...
export type BackgroundWorkerClientMessages = z.infer<
  typeof BackgroundWorkerClientMessages
>;
...
export const TaskMetadataFailedToParseData = z.object({
  version: z.literal("v1").default("v1"),
  tasks: z.unknown(),
  zodIssues: z.custom<z.ZodIssue[]>(
    (v: unknown) =>
      Array.isArray(v) &&
      v.every((issue) => typeof issue === "object" && "message" in issue),
  ),
});
