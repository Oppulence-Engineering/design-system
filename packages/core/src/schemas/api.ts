...
import { DeserializedJsonSchema } from "./json.ts";
import { BackgroundWorkerMetadata } from "./resources.ts";
...
export type CreateBackgroundWorkerRequestBody = z.infer<
  typeof CreateBackgroundWorkerRequestBody
>;
...
export type CreateBackgroundWorkerResponse = z.infer<
  typeof CreateBackgroundWorkerResponse
>;
...
export type BatchTriggerTaskRequestBody = z.infer<
  typeof BatchTriggerTaskRequestBody
>;
...
export type BatchTriggerTaskV2RequestBody = z.infer<
  typeof BatchTriggerTaskV2RequestBody
>;
...
export type BatchTriggerTaskV2Response = z.infer<
  typeof BatchTriggerTaskV2Response
>;
...
export type BatchTriggerTaskV3RequestBody = z.infer<
  typeof BatchTriggerTaskV3RequestBody
>;
...
export type BatchTriggerTaskV3Response = z.infer<
  typeof BatchTriggerTaskV3Response
>;
...
export type StartDeploymentIndexingRequestBody = z.infer<
  typeof StartDeploymentIndexingRequestBody
>;
...
export type FinalizeDeploymentRequestBody = z.infer<
  typeof FinalizeDeploymentRequestBody
>;
...
export type InitializeDeploymentResponseBody = z.infer<
  typeof InitializeDeploymentResponseBody
>;
...
export type InitializeDeploymentRequestBody = z.infer<
  typeof InitializeDeploymentRequestBody
>;
...
export type FailDeploymentRequestBody = z.infer<
  typeof FailDeploymentRequestBody
>;
...
export type FailDeploymentResponseBody = z.infer<
  typeof FailDeploymentResponseBody
>;
...
export type PromoteDeploymentResponseBody = z.infer<
  typeof PromoteDeploymentResponseBody
>;
...
export type GetDeploymentResponseBody = z.infer<
  typeof GetDeploymentResponseBody
>;

export const GetLatestDeploymentResponseBody = GetDeploymentResponseBody.omit({
  worker: true,
});
export type GetLatestDeploymentResponseBody = z.infer<
  typeof GetLatestDeploymentResponseBody
>;
...
export type WorkersCreateResponseBody = z.infer<
  typeof WorkersCreateResponseBody
>;
...
export type CreateUploadPayloadUrlResponseBody = z.infer<
  typeof CreateUploadPayloadUrlResponseBody
>;
...
export const ScheduleType = z.union([
...
export const UpdateScheduleOptions = CreateScheduleOptions.omit({
...
export type EnvironmentVariableResponseBody = z.infer<
  typeof EnvironmentVariableResponseBody
>;
...
export type EnvironmentVariableWithSecret = z.infer<
  typeof EnvironmentVariableWithSecret
>;

export const UpdateMetadataRequestBody = FlushedRunMetadata;

export type UpdateMetadataRequestBody = z.infer<
  typeof UpdateMetadataRequestBody
>;
...
export type UpdateMetadataResponseBody = z.infer<
  typeof UpdateMetadataResponseBody
>;

const RawShapeDate = z
  .string()
  .transform((val: string) => `${val}Z`)
  .pipe(z.coerce.date());
...
export type CreateWaitpointTokenRequestBody = z.infer<
  typeof CreateWaitpointTokenRequestBody
>;
...
export type CreateWaitpointTokenResponseBody = z.infer<
  typeof CreateWaitpointTokenResponseBody
>;

export const waitpointTokenStatuses = [
  "WAITING",
  "COMPLETED",
  "TIMED_OUT",
] as const;
...
export type WaitpointRetrieveTokenResponse = z.infer<
  typeof WaitpointRetrieveTokenResponse
>;

export const CompleteWaitpointTokenRequestBody = z.object({
  data: z.any().nullish(),
});
export type CompleteWaitpointTokenRequestBody = z.infer<
  typeof CompleteWaitpointTokenRequestBody
>;

export const CompleteWaitpointTokenResponseBody = z.object({
  success: z.literal(true),
});
export type CompleteWaitpointTokenResponseBody = z.infer<
  typeof CompleteWaitpointTokenResponseBody
>;

export const WaitForWaitpointTokenResponseBody = z.object({
  success: z.boolean(),
});
export type WaitForWaitpointTokenResponseBody = z.infer<
  typeof WaitForWaitpointTokenResponseBody
>;
...
export type WaitForDurationRequestBody = z.infer<
  typeof WaitForDurationRequestBody
>;
...
export type WaitForDurationResponseBody = z.infer<
  typeof WaitForDurationResponseBody
>;
