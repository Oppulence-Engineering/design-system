import { z } from "zod";
import { RunStatus } from "./api.ts";
import { TaskRunError } from "./common.ts";
import { EnvironmentType } from "./schemas.ts";
...
export type AlertWebhookRunFailedObject = z.infer<
  typeof AlertWebhookRunFailedObject
>;
...
export type AlertWebhookDeploymentFailedObject = z.infer<
  typeof AlertWebhookDeploymentFailedObject
>;
