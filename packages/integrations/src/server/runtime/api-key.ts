...
export const BUILT_IN_API_KEY_PROVIDER_CONFIGURATIONS = Object.freeze([
  ...
  {
    integrationId: "agentmail" as const,
    apiBaseUrl: "https://api.agentmail.to",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "agentphone" as const,
    apiBaseUrl: "https://api.agentphone.ai",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "ahrefs" as const,
    apiBaseUrl: "https://api.ahrefs.com/v3",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "apify" as const,
    apiBaseUrl: "https://api.apify.com",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "daytona" as const,
    apiBaseUrl: "https://app.daytona.io/api",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "devin" as const,
    apiBaseUrl: "https://api.devin.ai",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "granola" as const,
    apiBaseUrl: "https://public-api.granola.ai",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "infisical" as const,
    apiBaseUrl: "https://us.infisical.com",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "instantly" as const,
    apiBaseUrl: "https://api.instantly.ai",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "kalshi" as const,
    apiBaseUrl: "https://external-api.kalshi.com/trade-api/v2",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "launchdarkly" as const,
    apiBaseUrl: "https://app.launchdarkly.com",
    credentialHeader: "Authorization",
  },
  {
    integrationId: "leadmagic" as const,
    apiBaseUrl: "https://api.leadmagic.io",
    credentialHeader: "X-API-Key",
  },
  {
    integrationId: "lemlist" as const,
    apiBaseUrl: "https://api.lemlist.com/api",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "loops" as const,
    apiBaseUrl: "https://app.loops.so/api",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "mem0" as const,
    apiBaseUrl: "https://api.mem0.ai",
    credentialHeader: "Authorization",
  },
  {
    integrationId: "profound" as const,
    apiBaseUrl: "https://api.tryprofound.com",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "quartr" as const,
    apiBaseUrl: "https://api.quartr.com",
    credentialHeader: "X-Api-Key",
  },
  {
    integrationId: "sentry" as const,
    apiBaseUrl: "https://sentry.io",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "sixtyfour-ai" as const,
    apiBaseUrl: "https://api.sixtyfour.ai",
    credentialHeader: "x-api-key",
  },
  {
    integrationId: "stagehand" as const,
    apiBaseUrl: "https://api.browserbase.com",
    credentialHeader: "X-BB-API-Key",
  },
  {
    integrationId: "thrive" as const,
    apiBaseUrl: "https://api.thrive.app",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
    integrationId: "uptimerobot" as const,
    apiBaseUrl: "https://api.uptimerobot.com/v3",
    credentialHeader: "Authorization",
    credentialPrefix: "Bearer",
  },
  {
