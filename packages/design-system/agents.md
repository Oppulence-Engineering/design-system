...
This design system enforces strict styling through `class-variance-authority` (cva). The `className` prop has been removed from all components to prevent style overrides.
