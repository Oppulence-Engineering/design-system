...
export const Icons = {
  ...
  Logo: (props: Omit<SVGProps<SVGSVGElement>, "className">) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={113}
      height={32}
  ...
  Decimals: ({ size = 24, ...props }: SvgProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size}
      viewBox="0 -960 960 960"
  ...
  CreateTransaction: (props: SvgProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={props.size ?? 24}
      height={props.size ?? 24}
  ...
  Overview: createReactIcon(MdOutlineWidgets),
  Inbox: createRadixIcon(ArchiveIcon),
  Close: createReactIcon(MdClose),
  X: (props: SVGIconProps) => (
    <SVGIcon {...props} viewBox="0 0 24 24" fill="currentColor">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </SVGIcon>
  ),
  Discord: createReactIcon(PiDiscordLogo),
  PdfOutline: createReactIcon(MdOutlinePictureAsPdf),
  Amount: createReactIcon(MdOutlineEqualizer),
  Attachments: createReactIcon(MdOutlineAttachFile),
  GithubOutline: createReactIcon(FiGithub),
  Refresh: createReactIcon(MdRefresh),
  Currency: createReactIcon(MdAttachMoney),
  Inventory2: createReactIcon(MdInventory2),
  Notifications: createReactIcon(MdOutlineNotificationsNone),
  ChevronDown: createReactIcon(MdExpandMore),
  ChevronUp: createReactIcon(MdExpandLess),
  TrendingUp: createReactIcon(MdTrendingUp),
  TrendingDown: createReactIcon(MdTrendingDown),
  Category: createReactIcon(MdOutlineCategory),
  Visibility: createReactIcon(MdOutlineVisibility),
  Face: createReactIcon(MdOutlineFace),
  MoreHoriz: createReactIcon(MdMoreHoriz),
  Pdf: createReactIcon(MdPictureAsPdf),
  BrokenImage: createReactIcon(MdOutlineBrokenImage),
  Description: createReactIcon(MdDescription),
  FolderZip: createReactIcon(MdFolderZip),
  ChevronRight: createReactIcon(MdChevronRight),
  ChevronLeft: createReactIcon(MdChevronLeft),
  ArrowBack: createReactIcon(MdArrowBack),
  ArrowForward: createReactIcon(MdArrowForward),
  Folder: createReactIcon(MdFolder),
  Search: createReactIcon(MdSearch),
  Error: createReactIcon(MdErrorOutline),
  AI: createReactIcon(MdAutoAwesome),
  AIOutline: createReactIcon(MdOutlineAutoAwesome),
  Time: createReactIcon(MdOutlineMoreTime),
  Add: createReactIcon(MdOutlineAdd),
  Copy: createReactIcon(MdOutlineContentCopy),
  Share: createReactIcon(MdIosShare),
  Play: createReactIcon(MdPlayArrow),
  Stop: createReactIcon(MdStop),
  StopOutline: createReactIcon(MdOutlineStop),
  PlayOutline: createReactIcon(MdOutlinePlayArrow),
  MoreVertical: createReactIcon(MdOutlineMoreVert),
  Match: createReactIcon(MdOutlineTask),
  History: createReactIcon(MdOutlineHistory),
  Email: createReactIcon(MdOutlineEmail),
  Tune: createReactIcon(MdOutlineTune),
  Change: createReactIcon(MdChangeHistory),
  CalendarMonth: createReactIcon(MdOutlineCalendarMonth),
  Sort: createReactIcon(MdSort),
  Palette: createReactIcon(MdOutlinePalette),
  Menu: createReactIcon(MdMenu),
  Mute: createReactIcon(MdOutlineVolumeOff),
  UnMute: createReactIcon(MdOutlineVolumeUp),
  Clear: createReactIcon(MdOutlineClear),
  Filter: createReactIcon(MdOutlineFilterList),
  Status: createReactIcon(MdOutlineStyle),
  Accounts: createReactIcon(MdOutlineAccountBalance),
  ArrowRightAlt: createReactIcon(MdArrowRightAlt),
  AccountCircle: createReactIcon(MdOutlineAccountCircle),
  Repeat: createReactIcon(MdOutlineRepeat),
  ProjectStatus: createReactIcon(MdDownloading),
  Edit: createReactIcon(MdOutlineEditNote),
  OpenInNew: createReactIcon(MdOutlineOpenInNew),
  DragIndicator: createReactIcon(MdDragIndicator),
  ExternalLink: createReactIcon(MdOutlineLaunch),
  Link: createReactIcon(MdOutlineLink),
  CropFree: createReactIcon(MdOutlineCropFree),
  DateFormat: createReactIcon(MdOutlineFactCheck),
  Tax: createReactIcon(MdOutlineAssuredWorkload),
  Vat: createReactIcon(MdOutlineCalculate),
  CurrencyOutline: createReactIcon(MdOutlineAttachMoney),
  SnippetFolder: createReactIcon(MdSnippetFolder),
  ConfirmationNumber: createReactIcon(MdOutlineConfirmationNumber),
  QrCode: createReactIcon(MdOutlineQrCode2),
  ArrowOutward: createReactIcon(MdOutlineArrowOutward),
  Straighten: createReactIcon(MdOutlineSquareFoot),
  Files: createReactIcon(MdOutlineInventory2),
  GridView: createReactIcon(MdOutlineGridView),
  ListView: createReactIcon(MdOutlineReorder),
  ArrowDownward: createReactIcon(MdArrowDownward),
  ArrowUpward: createReactIcon(MdArrowUpward),
  SubdirectoryArrowLeft: createReactIcon(MdOutlineSubdirectoryArrowLeft),
  OutgoingMail: createReactIcon(MdOutlineSignpost),
  AttachEmail: createReactIcon(MdOutlineAttachEmail),
  SyncAlt: createReactIcon(MdOutlineSyncAlt),
  InfoOutline: createReactIcon(MdOutlineInfo),
  DashboardCustomize: createReactIcon(MdOutlineDashboardCustomize),
  ThumbUp: createReactIcon(MdOutlineThumbUp),
  ThumbDown: createReactIcon(MdOutlineThumbDown),
  ThumbUpOutline: createReactIcon(MdOutlineThumbUp),
  ThumbDownOutline: createReactIcon(MdOutlineThumbDown),
  RefreshOutline: createReactIcon(MdOutlineRefresh),
  Globle: createReactIcon(MdOutlineLanguage),
  Record: createReactIcon(MdOutlineGraphicEq),
  Speed: createReactIcon(MdOutlineStackedBarChart),
  ReceiptLong: createReactIcon(MdOutlineReceiptLong),
  Bolt: createReactIcon(MdBolt),
  Star: createReactIcon(MdOutlineStar),
  ShowChart: createReactIcon(MdOutlineShowChart),
  PieChart: createReactIcon(MdOutlinePieChart),
  ArrowDropDown: createReactIcon(MdArrowDropDown),
  Block: createReactIcon(MdOutlineBlock),
  ListAlt: createReactIcon(MdOutlineListAlt),
  ...
  QuickBooks: ({ size = 40, ...props }: SvgProps) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 40 40"
  ...
  Fortnox: ({ size = 40, ...props }: SvgProps) => (
    <svg
      width={size}
      height={size}
